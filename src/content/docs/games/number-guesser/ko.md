...
이 전략을 계속 쓰면 몇 번 만에 범위가 좁아질지 계산해보면, 딱 7번이면 100개 중에서 어떤 숫자든 찾아낼 수 있습니다. 이것은 컴퓨터 과학에서 이진 탐색이라고 부르는 방법과 정확히 같습니다.
...
예를 들어 힌트를 통해 범위가 63~74로 좁혀졌다면, 다음 추측은 63과 74를 더해 2로 나눈 68이 됩니다. 범위가 홀수개면 어느 쪽을 고르든 큰 차이는 없습니다.
...
적은 횟수일수록 좋은 점수입니다. 최고 기록은 브라우저 탭을 닫거나 새로 고침할 때까지 유지됩니다.
...
**모바일에서도 플레이할 수 있나요?**
네. 게임은 브라우저에서 완전히 작동하며, 스마트폰과 태블릿에서도 잘 작동합니다.
